...
<body>
    ...
    <div id="main" class="fix-sidebar">
            ...
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        ...
                        <li><a href="<c:url value="/customextension/" />" style="text-decoration: none;" class="sidebar-link current">自定义扩展方法</a></li>
        ...
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='../page/自定义扩展的方法_11.html' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
