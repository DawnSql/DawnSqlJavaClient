...
<body>
    ...
    <div id="main" class="fix-sidebar">
            ...
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        ...
                        <li><a href="<c:url value="/ddl/" />" style="text-decoration: none;" class="sidebar-link current">DLL的支持</a></li>
        ...
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='../page/DLL的支持_6.html' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
