...
<body>
    ...
    <div id="main" class="fix-sidebar">
            ...
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        ...
                        <li><a href="<c:url value="/installation/" />" style="text-decoration: none;" class="sidebar-link">安装</a></li>
                        ...
                        <li><a href="<c:url value="/jdbc/" />" style="text-decoration: none;" class="sidebar-link current">JDBC访问DawnSql数据库</a></li>
        ...
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='../page/jdbc访问DawnSql数据库_12.html' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
