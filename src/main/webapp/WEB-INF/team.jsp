    ...
    <div id="main" class="fix-sidebar">
        <div class="sidebar">
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        <li><a href="<c:url value="/team" />" style="text-decoration: none;" class="sidebar-link current">团队</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='<c:url value="/my_team" />' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
