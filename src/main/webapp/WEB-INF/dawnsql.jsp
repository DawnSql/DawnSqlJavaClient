...
<body>
    ...
    <div id="main" class="fix-sidebar">
            ...
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        ...
                        <li><a href="<c:url value="/dawnsql/" />" style="text-decoration: none;" class="sidebar-link current">DawnSql语法</a></li>
        ...
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='../page/DawnSql语法_2.html' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
