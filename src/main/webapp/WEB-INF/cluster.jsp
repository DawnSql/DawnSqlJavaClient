            ...
            <div class="sidebar-inner">
                <div class="list">
                    <ul class="menu-root">
                        ...
                        <li><a href="<c:url value="/cluster/" />" style="text-decoration: none;" class="sidebar-link current">集群异地强一致性实时多活</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div id="show_doc" class="content guide with-sidebar installation-guide">
            <iframe src='../page/DawnSql_cluster_consistence_13.html' scrolling='no' style="overflow:visible;" frameborder='0' width='100%' height='100%'></iframe>
        </div>
    </div>
</body>
</html>
